(() => {
  ...
  const messages = {
    en: {
      ...
      'voice.keepSpeakerAudible': 'Keep this phone speaker audible for a moment.',
      ...
      'voice.useHeadphones': 'Use headphones so the song stays out of your mic.',
      ...
      'take.last': 'Last take · {duration} · {verdict}',
      ...
      'take.verdict.clean': 'Clean',
      'take.verdict.review': 'Review',
      'take.verdict.degraded': 'Degraded',
      'take.verdict.ready': 'Ready',
      ...
      'system.lastTakeState': 'Last take {verdict}.',
    ...
    'zh-Hant': {
      ...
      'voice.keepSpeakerAudible': '請讓這支手機的喇叭短暫保持有聲。',
      ...
      'voice.useHeadphones': '請戴耳機，避免歌曲被這支手機的 Mic 再收進去。',
      ...
      'take.record': '錄製 Take',
      'take.stop': '停止',
      'take.finishing': '正在完成 Take…',
      'take.last': '上一個 Take · {duration} · {verdict}',
      'take.lastReady': '上一個 Take',
      'take.download': '下載 WAV',
      'take.reviewReleaseMic': '請先放開 Mic，再播放上一個 Take。',
      'take.reviewPausedForMic': '這支手機拿到 Mic，Take 回放已暫停。',
      'take.failed': 'Take {id} 錄製失敗',
      'take.verdict.clean': '乾淨',
      'take.verdict.review': '需檢查',
      'take.verdict.degraded': '品質下降',
      'take.verdict.ready': '完成',
      'take.reconnectingError': 'Relay 正在重新連線，Take 沒有變更。',
      'take.reject.participant-required': '需要先建立 Relay 參與者身分。',
      'take.reject.mix-not-active': '目前還沒有可錄製的房間混音。',
      'take.reject.song-required': '加入歌曲後才能錄製 Take。',
      'take.reject.product-blocked': '請先處理房間音訊問題再錄製 Take。',
      'take.reject.take-not-ready': '房間目前還不能開始錄製。',
      'take.reject.take-active': '已有 Take 正在錄製或完成中。',
      'take.reject.take-not-recording': '目前沒有正在錄製的 Take。',
      'take.reject.stale-take': '這次停止操作屬於較舊的 Take。',
      'take.reject.invalid-take-id': 'Relay 無法辨識要停止的 Take。',
      'take.reject.writer-failed': 'Relay 無法啟動 Take 錄音器。',
      'take.reject.storage-unavailable': '目前無法使用錄音儲存空間。',
      'take.reject.unknown': 'Take 被拒絕：{reason}',
      ...
      'system.recordingDetail': '目前與最近一次 Take 狀態。',
      ...
      'system.take.lastReady': '上一個 Take 已完成',
      ...
      'system.attention.take-failed': 'Take 錄製失敗',
      ...
      'system.lastTakeState': '上一個 Take {verdict}。',
