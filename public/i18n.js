(() => {
  ...
  const messages = {
    en: {
      ...
      'voice.droppingOutYours': 'Mic audio dropping out',
      'voice.audioNotReachingRoom': 'The Mic is connected, but much of your audio is not reaching the room.',
      ...
      'voice.droppingOutOther': 'microphone audio dropping out',
      ...
      'adjust.inputClipping': 'Microphone input is clipping',
      'adjust.inputClippingHelp': 'The waveform is already flattening before Relay gain. Move the phone farther from the voice or reduce the device input level; lowering Relay Mic gain cannot restore clipped peaks.',
      'adjust.processingActive': 'Browser voice processing is on',
      'adjust.processingActiveHelp': 'Echo cancellation, noise suppression, or automatic gain is still processing the input. It can make singing sound robotic; Mic gain cannot undo it.',
      ...
      'system.attention.mic-input-clipping': 'Microphone input is clipping',
    ...
    'zh-Hant': {
      ...
      'voice.droppingOutYours': 'Mic 聲音斷斷續續',
      'voice.audioNotReachingRoom': 'Mic 仍連線，但你的聲音有很多沒有送到房間。',
      'voice.ready': '準備好了',
      ...
      'voice.droppingOutOther': '麥克風聲音斷斷續續',
      'voice.someone': '有人',
      ...
      'adjust.inputClipping': '麥克風輸入已削波',
      'adjust.inputClippingHelp': '波形在進入 Relay gain 前就已經被削平。把手機離人聲遠一點或降低裝置輸入；只調低 Relay Mic gain 無法恢復被削掉的峰值。',
      'adjust.processingActive': '瀏覽器語音處理仍開啟',
      'adjust.processingActiveHelp': '回音消除、降噪或自動增益仍在處理輸入，可能讓歌聲變成機器聲；Mic gain 無法修復。',
      ...
      'system.attention.mic-input-clipping': '麥克風輸入已削波',
