...
// fallback; the page answers each sequence once, whichever arrives first.
//
//   offset  size  field
...
export function encodeRetransmitRequest(captureGeneration, sequences) {
...
export function decodeRetransmitRequest(bytes) {
  ...
  return { captureGeneration: view.getUint32(4, true), sequences };
}
